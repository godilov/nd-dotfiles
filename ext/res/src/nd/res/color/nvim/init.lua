...
local nd_err     = assert_lib.get_err_fn 'nd.res.color.nvim'
...
return function(config)
    ...
    local accent    = load_fn('nd.res.color.nvim.accent', accent_cfg, { palette = palette })
    local highlight = load_fn('nd.res.color.nvim.highlight', highlight_cfg, {
        palette = palette,
        accent  = accent,
    })

    local special   = special_cfg and load_fn('nd.res.color.nvim.special', special_cfg, {
        palette   = palette,
        accent    = accent,
        highlight = highlight,
    })
