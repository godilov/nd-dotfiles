...
local nd_err     = assert_lib.get_err_fn 'nd.res.color.awesome'
...
return function(config)
    ...
    local accent  = load_fn('nd.res.color.awesome.accent', accent_cfg, { palette = palette })
    local theme   = load_fn('nd.res.color.awesome.theme', theme_cfg, { palette = palette, accent = accent })
