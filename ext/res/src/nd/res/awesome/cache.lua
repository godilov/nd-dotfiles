...
get_colors = function(config, is_forced)
    ...
    local key = get_colors_keyname { 'awesome', palette_n, accent_n }

    return get_colors_scheme(awesome_colors_fn, config, key, is_forced)
end
...
get_keys = function(config, is_forced)
    ...
    local key = get_keys_keyname { 'awesome', scheme_n }

    return get_keys_scheme(awesome_keys_fn, config, key, is_forced)
end
