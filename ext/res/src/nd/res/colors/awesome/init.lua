...
local nd_err     = assert_lib.get_err_fn 'nd.res.colors.awesome'
...
return function(config)
    ...
    local accent  = load_fn('nd.res.colors.awesome.accent', accent_cfg, { palette = palette })
    local theme   = load_fn('nd.res.colors.awesome.theme', theme_cfg, { palette = palette, accent = accent })
