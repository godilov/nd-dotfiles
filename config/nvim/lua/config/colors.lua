...
local syntax = {
    ...
    ['comment.error']       = { fg = palette.red.light, reverse = true },
    ['comment.warning']     = { fg = palette.yellow.light, reverse = true },
    ['comment.todo']        = { fg = palette.green.light, reverse = true },
    ['comment.note']        = { fg = palette.blue.light, reverse = true },
}
